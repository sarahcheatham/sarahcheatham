    ...
    render(){
        return(
            <div className="experiences">
               <h3 className="job-title">Austin Coding Academy<br/><i className="work-italics">JavaScript Tutor</i></h3>
               <h3 className="work-dates">Decemeber 2018 - Present</h3>
               <p className="desc">
                ...
                <h3 className="job-title">Harmony Science Academy Austin<br/><i className="work-italics">Teacher and Curriculum Writer</i></h3>
               <h3 className="work-dates">August 2015 - Present</h3>
               <p className="desc">
